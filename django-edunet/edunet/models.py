...
class Course(models.Model):
    ...
    course_season = models.CharField(max_length=25)
    course_url = models.URLField(max_length=150)
    course_description = models.TextField(max_length=1000)
    course_structure = models.TextField(max_length=500)
...
class TreeOfKnowledge(models.Model):
    '''Class model used for the Tree of Knowledges generated by the course_processor.'''
    course = models.ForeignKey(Course, on_delete=models.CASCADE) # pylint: disable=line-too-long
...
class PuzzleOfKnowledge(models.Model):
    '''Class model used for the Puzzle of Knowledge generated by the course_processir.'''
    course = models.ForeignKey(Course, on_delete=models.CASCADE) # pylint: disable=line-too-long
    transcript_num = models.IntegerField()
    puzzle_of_knowledge = models.TextField()

    def __str__(self):
        return self.course.course_number + ' Puzzle'
